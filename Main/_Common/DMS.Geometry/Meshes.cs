...
namespace DMS.Geometry
{
    public static partial class Meshes
    {
        ...
        public static Mesh CreateCuboid(float sizeX, float sizeY, float sizeZ, uint segmentsX, uint segmentsY, uint segmentsZ)
        {
        ...
        public static Mesh CreateCuboid(Vector3 size, uint segmentsX, uint segmentsY, uint segmentsZ) {
